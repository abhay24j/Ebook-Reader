...
-(void)fixedViewController:(FixedViewController*)rvc insertHighlight:(Highlight*)highlight NS_SWIFT_NAME(fixedViewController(_:didInsert:));
/** called when certain highlight should be deleted in the case like merging highlights. */
-(void)fixedViewController:(FixedViewController*)rvc deleteHighlight:(Highlight*)highlight NS_SWIFT_NAME(fixedViewController(_:didDelete:));
/** called when certain highlight should be updated in the case like changing color */
-(void)fixedViewController:(FixedViewController*)rvc updateHighlight:(Highlight*)highlight NS_SWIFT_NAME(fixedViewController(_:didUpdate:));
...
-(void)fixedViewController:(FixedViewController*)rvc didHitHighlight:(Highlight*)highlight atPosition:(CGPoint)position NS_SWIFT_NAME(fixedViewController(_:didHitHighlight:at:));
